...
public class RegisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register);
        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE,R.layout.activity_register);
    ...
    public void onClickok3(View view) {
        {
            startActivityForResult(new Intent(RegisterActivity.this, AppointActivity.class), 1);
        }
    ...
    public boolean  SumbitData()
    {
        ...
        if (strMobile.isEmpty() || strMobile.length() < 11 || strCard.isEmpty()|| strName.isEmpty()||strPassword.isEmpty())  {
...
//                    out.print(param);
                    ...
                    HttpPost request = new HttpPost("http://192.168.2.106/register.php");
